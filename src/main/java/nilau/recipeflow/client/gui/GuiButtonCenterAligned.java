...
public class GuiButtonCenterAligned extends GuiButton {
    ...
    public GuiButtonCenterAligned(int p_i1021_1_, int p_i1021_2_, int p_i1021_3_, int p_i1021_4_, int p_i1021_5_, String p_i1021_6_, float p_scale) {
    ...
    public void drawButton(Minecraft p_146112_1_, int p_146112_2_, int p_146112_3_) {
    	if (this.visible) {
			...
			guiExtended.drawCenteredString(fontrenderer, this.displayString, Math.round(this.xPosition / scale) + this.width / 2, Math.round(this.yPosition / scale) + (this.height - 8) / 2, scale, l);
        }
    }
