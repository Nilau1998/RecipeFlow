...
public class GuiButtonLeftAligned extends GuiButton {
    ...
    public GuiButtonLeftAligned(int p_i1021_1_, int p_i1021_2_, int p_i1021_3_, int p_i1021_4_, int p_i1021_5_, String p_i1021_6_, float p_scale) {
